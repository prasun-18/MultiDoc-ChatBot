...
def get_detailed_answer(context, query, answer):
    # Locate sentences around the answer for elaboration
...
def get_answer_from_vector_store(vector_store, query, df=None):
    if df is not None:  # Handle structured queries (e.g., for tables)
...
if __name__ == "__main__":
    ...
    if not os.path.exists(file_path):
        ...
        print("Welcome to the Enhanced Bot!")
        print("Type your questions below. Type 'quit' or 'exit' to end the session.")
